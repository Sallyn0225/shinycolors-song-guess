...
### Package: @scg/server (`spec/server/`)

- Backend guidelines: `.trellis/spec/server/backend/`

- Frontend guidelines: `.trellis/spec/server/frontend/`

### Package: @scg/web (`spec/web/`)

- Frontend guidelines: `.trellis/spec/web/frontend/`

### Package: @scg/game-core (`spec/game-core/`)

- Backend guidelines: `.trellis/spec/game-core/backend/`

- Frontend guidelines: `.trellis/spec/game-core/frontend/`

### Package: @scg/shared (`spec/shared/`)

- Backend guidelines: `.trellis/spec/shared/backend/`

- Frontend guidelines: `.trellis/spec/shared/frontend/`

### Package: @scg/prepare-audio (`spec/prepare-audio/`)

- Backend guidelines: `.trellis/spec/prepare-audio/backend/`

- Frontend guidelines: `.trellis/spec/prepare-audio/frontend/`
